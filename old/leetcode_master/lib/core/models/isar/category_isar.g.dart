...
const CategoryIsarSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'premium': PropertySchema(id: 2, name: r'premium', type: IsarType.bool),
  },
...
void _categoryIsarSerialize(
  ...
  writer.writeBool(offsets[2], object.premium);
}
...
CategoryIsar _categoryIsarDeserialize(
  ...
  final object = CategoryIsar(
    ...
    premium: reader.readBool(offsets[2]),
  );
  return object;
}
...
extension CategoryIsarQueryWhere
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryIsarQueryFilter
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterFilterCondition>
  premiumEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'premium', value: value),
      );
    });
  }
}
...
extension CategoryIsarQuerySortBy
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> sortByPremium() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'premium', Sort.asc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> sortByPremiumDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryIsarQuerySortThenBy
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> thenByPremium() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'premium', Sort.asc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> thenByPremiumDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'premium', Sort.desc);
    });
  }
...
extension CategoryIsarQueryWhereDistinct
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QDistinct> distinctByPremium() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryIsarQueryProperty
  ...
  QueryBuilder<CategoryIsar, bool, QQueryOperations> premiumProperty() {
    return QueryBuilder.apply(this, (query) {
